...
<?php if ($_GET["page"]==""){$_GET["page"]=1;}$next=$_GET["page"]+1;$uppage=$_GET["page"]-1;$url=$请求路径;
 function isImage($filename){$types = '/(\.jpg$|\.png$|\.jpeg$)/i';if(preg_match($types, trim($filename))){return true;}else{ return false;}}?>
 <?php view::layout('layout')?>
 <?php view::begin('content');?><script>
...
<div class="mdui-fab-wrapper" id="exampleFab"  mdui-fab="options">
  ...
  <div class="mdui-fab-dial">
    ...
    <button class="mdui-fab mdui-fab-mini mdui-ripple mdui-color-red " onclick="create_folder()"><i class="mdui-icon material-icons">add</i></button></div>
</div>
